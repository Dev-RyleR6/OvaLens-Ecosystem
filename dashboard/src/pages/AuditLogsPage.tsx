                ...
                >
                  ...
                  <td className="py-3 px-4">
                    {log.severity === 'SECURITY' ? (
                      <span className="inline-flex items-center gap-2 text-xs font-semibold text-rose-800 bg-rose-50 w-24 px-2.5 py-1 rounded-md border border-rose-200">
                        <ShieldAlert className="w-3.5 h-3.5 text-rose-600 shrink-0" />
                        <span>Security</span>
                      </span>
                    ) : log.severity === 'WARNING' ? (
                      <span className="inline-flex items-center gap-2 text-xs font-semibold text-amber-900 bg-amber-50 w-24 px-2.5 py-1 rounded-md border border-amber-200">
                        <AlertTriangle className="w-3.5 h-3.5 text-amber-600 shrink-0" />
                        <span>Warning</span>
                      </span>
                    ) : (
                      <span className="inline-flex items-center gap-2 text-xs font-semibold text-slate-700 bg-slate-100 w-24 px-2.5 py-1 rounded-md border border-slate-200">
